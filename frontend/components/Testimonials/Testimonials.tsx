  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
        <motion.h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-center mb-12 sm:mb-16 md:mb-20 font-montserrat bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent dark:text-blue-200">
            ...
            >
              <div className="bg-white/40 dark:bg-gray-800 rounded-3xl shadow-xl p-6 sm:p-8 md:p-10 lg:p-10 xl:p-12 backdrop-blur-lg w-full flex items-center justify-center">
                <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4 md:space-y-6 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl">
                  <motion.div>
                    <Quote className="w-10 sm:w-12 md:w-14 lg:w-14 xl:w-16 2xl:w-20 h-10 sm:h-12 md:h-14 lg:h-14 xl:h-16 2xl:h-20 text-[#003366] dark:text-blue-300" />
                  </motion.div>
                  <motion.p
