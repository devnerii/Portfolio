...
const socialIcons = [
  { Icon: Linkedin, href: 'https://www.linkedin.com/in/daniel-neri-51a7b12b3' },
  { Icon: Github, href: 'https://github.com/devnerii' },
  { Icon: Instagram, href: 'https://instagram.com/nerix' },
  { Icon: SiFreelancer, href: 'https://www.freelancer.com/u/devneri' },
  { Icon: Briefcase, href: 'https://www.workana.com/freelancer/605927d469678a6ae9166b97adaf1160' },
];

const footerLinks = [
  { title: 'home', href: '#home' }, // Alterado para #home
  { title: 'about', href: '#sobre' }, // Alterado para #sobre
  { title: 'services', href: '#servicos' }, // Alterado para #servicos
  { title: 'contact', href: '#contato' }, // Alterado para #contato
];
