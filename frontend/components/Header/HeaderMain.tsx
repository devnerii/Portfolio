      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-7">
            <div>
              <a href="#" className="flex items-center space-x-2">
                <span className="font-bold text-[#003366] text-2xl">Logo</span>
              </a>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-[#003366] text-lg font-medium hover:text-[#007BFF] transition duration-300">Home</a>
            <a href="#" className="text-[#003366] text-lg font-medium hover:text-[#007BFF] transition duration-300">Sobre</a>
            <a href="#" className="text-[#003366] text-lg font-medium hover:text-[#007BFF] transition duration-300">Serviços</a>
            <a href="#" className="text-[#003366] text-lg font-medium hover:text-[#007BFF] transition duration-300">Contato</a>
          </div>
